...
# TODO Check for instruction prompting duplicates when doing dialog --> Seems generated by the model. Maybe add prompt to wait with recommendations until asked?
# TODO Number of teams and players does not affect bench data --> should also cut it?
# TODO Add sanity check (at least one action taken?)
